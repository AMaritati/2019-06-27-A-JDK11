...
public class EventsDao {
	...
	public List<String> listVertices(String cat, Integer year){
	...
	public List<Adiacenza> listAdiacenze(String cat, Integer year){
		String sql = "SELECT e1.offense_type_id AS of1, e2.offense_type_id AS of2, COUNT(DISTINCT e1.district_id) AS c " + 
				"FROM events e1, events e2 " + 
				"WHERE e1.offense_category_id = ? AND " + 
				"YEAR(e1.reported_date) = ? AND e2.offense_category_id = ? " + 
				"AND YEAR(e2.reported_date) = ? AND e1.offense_type_id>e2.offense_type_id " + 
		...
		try {
			...
			while(res.next()) {
					...
					list.add(new Adiacenza(res.getString("of1"),res.getString("of2"),res.getInt("c")));
